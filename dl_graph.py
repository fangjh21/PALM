    ...
    def Encoder(name='Bert-base',B=512,S=512,H=1024,A=12,H1=1024*4,L=12):
        if name in ['Bert-base','Bert-large','T-18B','T-39B','T-76B','T-145B','T-310B','T-530B','T-1T','GPT3-175B','LLaMA2-7B']:
            if name=='Bert-base':
                ...
                L,B,S,H,A,H1=48,1536,2048,8192,64,8192*4   
            elif name=='T-76B':
                L,B,S,H,A,H1=60,1792,2048,10240,80,10240*4   
            elif name=='T-145B':
                L,B,S,H,A,H1=80,2304,2048,12288,96,12288*4   
            elif name=='T-310B':
                L,B,S,H,A,H1=96,2160,2048,16384,128,16384*4   
            elif name=='T-530B':
                L,B,S,H,A,H1=105,2520,2048,20480,128,20480*4     
            elif name=='T-1T':
                L,B,S,H,A,H1=128,3072,2048,25600,128,25600*4  
            elif name=='GPT3-175B':
                L,B,S,H,A,H1=96,1564,2048,12288,96,12288*4  
            elif name=='LLaMA2-7B':
